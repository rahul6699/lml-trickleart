        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    <h5 class="card-title mb-0 flex-grow-1">Lead Status List</h5>
                    <div>
                        <button id="addRow" type="button" class="btn btn-primary" onclick="addForm(this)">Add Lead Status</button>
                    </div>
                </div>
                <div class="card-body">
...
$(document).ready(function() {
    ...
    window.table = $('#datatable').DataTable({
        ...
        serverSide: true,
        ajax: {
            "url": "{{ route('admin.lead_status.list') }}",
            "type": "POST",
            "dataType": "json",
        },
        columns: [{
...
function addForm(e) {
   $.ajax({
       url: "{{ route('admin.lead_status.create' )}}",
       type: "GET",
       dataType: "json",
