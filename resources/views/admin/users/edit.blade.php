        ...
        @csrf
            <div class="row g-3">
                <div class="col-md-12 mt-3">
                    ...
                    <input name="name" id="" class="form-control" value="{{ $admin->name }}">
                </div>
                <div class="col-md-12 mt-3">
                    <label class="form-label">Username<sup class="text-danger"></sup></label>
                    <input name="username" id="" class="form-control" value="{{ $admin->username }}">
                </div>
                <div class="col-md-12 mt-3">
                    <label class="form-label">Email<sup class="text-danger"></sup></label>
                    <input name="email" id="" class="form-control" value="{{ $admin->email }}">
                </div>
                <div class="col-md-12 mt-3">
                ...
                <div class="col-md-12 mt-3">
                    ...
                    <select class="form-select" name="status" id="statusSelect" data-placeholder="Select Status">
                        ...
                        <option value="1" @if(1==$admin->status) selected="selected" @endif>Active</option>
                        <option value="0" @if(0==$admin->status) selected="selected" @endif>Inactive</option>
                    </select>
                </div>
