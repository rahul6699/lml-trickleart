        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    <h5 class="card-title mb-0 flex-grow-1">Notes List</h5>
                    <div>
                        <button id="addRow" type="button" class="btn btn-primary" onclick="addForm(this)">Add New Note</button>
                    </div>
                </div>
                <div class="card-body">
