                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="name" class="form-control" placeholder="Enter your fullname" id="fullName">
                                            </div>
                                        </div><!--end col-->
                                        <div class="col-12">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="date" name="dob" class="form-control" placeholder="Enter your birthday" id="birthday">
                                            </div>
                                        </div><!--end col-->
                                        <div class="col-12">
                                            <div class="mb-3">
                                                <label for="contact_number" class="form-label">Contact Number</label>
                                                <input type="text" name="contact_no" class="form-control" placeholder="Enter your contact number" id="contact_number">
                                            </div>
                                        </div><!--end col-->
                                        <div class="col-12">
                                            <div class="mb-3">
                                                <label for="whatsapp_number" class="form-label">Whatsapp Number</label>
                                                <input type="text" name="whatsapp_no" class="form-control" placeholder="Enter your whatsapp number" id="whatsapp_number">
                                            </div>
                                        </div><!--end col-->
                                        <div class="col-12">
                                            <div class="mb-3">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 ">
                                            ...
                                            <input name="interested_in" id="" class="form-control">
                                        </div>
                                        <div class="col-12 mt-3">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-md-12 mt-3">
                                            ...
                                            <select class="form-select" name="lead_status_id" id="statusSelect"
                                                ...
                                                @foreach($leadStatus as $sVal1)
                                                    <option value="{{$sVal1->id}}">{{$sVal1->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
